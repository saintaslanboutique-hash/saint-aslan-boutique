...
export default function NewProductsSection() {
    ...
    return (
        <section className="relative flex w-full flex-col overflow-hidden">
            <div className="relative z-20 w-full border-t border-neutral-200/80 bg-neutral-50 px-3 py-10 sm:px-4 sm:py-12 md:px-6 lg:px-8 lg:py-16">
                <div className="mb-12 flex items-center justify-center">
                    <h2 className="-tracking-[14px] text-center text-8xl font-semibold uppercase">
                        {t('newProducts')}
                    </h2>
                </div>
